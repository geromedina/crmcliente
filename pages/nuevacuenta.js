...
const NuevaCuenta = () => {
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            password: Yup.string().required('El password no puede ir vacio').min(6, 'El password debe ser de 6 caracteres')
    ...
    const mostrarMensaje = () => {
        return (
            <div className="bg-white py-2 px-3 w-full my-3 max-w-sm text-center mx-auto font-normal">
                <p>{mensaje}</p>
            </div>
        )
    }
    ...
    return (
        ...
        <>
            <Layout>
                ...
                <h1 className="text-center text-2xl text-white font-normal">Crear Nueva Cuenta</h1>
